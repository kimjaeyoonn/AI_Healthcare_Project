 ...
 */
public abstract class Hilt_NotAvailableFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NotAvailableFragment() {
    super();
  }

  Hilt_NotAvailableFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NotAvailableFragment_GeneratedInjector) this.generatedComponent()).injectNotAvailableFragment(UnsafeCasts.<NotAvailableFragment>unsafeCast(this));
    }
  }
