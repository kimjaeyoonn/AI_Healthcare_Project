 ...
 */
public abstract class Hilt_ExerciseFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ExerciseFragment() {
    super();
  }

  Hilt_ExerciseFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ExerciseFragment_GeneratedInjector) this.generatedComponent()).injectExerciseFragment(UnsafeCasts.<ExerciseFragment>unsafeCast(this));
    }
  }
