 ...
 */
public abstract class Hilt_PrepareFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PrepareFragment() {
    super();
  }

  Hilt_PrepareFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PrepareFragment_GeneratedInjector) this.generatedComponent()).injectPrepareFragment(UnsafeCasts.<PrepareFragment>unsafeCast(this));
    }
  }
