 ...
 */
public abstract class Hilt_StartupFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_StartupFragment() {
    super();
  }

  Hilt_StartupFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((StartupFragment_GeneratedInjector) this.generatedComponent()).injectStartupFragment(UnsafeCasts.<StartupFragment>unsafeCast(this));
    }
  }
